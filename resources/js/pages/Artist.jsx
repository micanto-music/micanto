    ...
    return (
        <>
            <Scroll>
                ...
                <CompactHeader title={artist?.name} context={context} />
                    ...
                    {albums?.length > 0 && <>
                        <h3 className="flex flex-row justify-between">
                            ...
                            <div className="btn-list">
                                <button className={classNames('mr-2', {'active': tab === 'grid'})}
                                        onClick={() => setTab('grid')}><LuLayoutGrid/></button>
                                <button className={classNames({'active': tab === 'list'})}
                                        onClick={() => setTab('list')}><LuLayoutList/></button>
                            </div>
                        </h3>
                        {tab == 'grid' &&
